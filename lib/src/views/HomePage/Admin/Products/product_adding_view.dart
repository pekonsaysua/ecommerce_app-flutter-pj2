...
import 'package:ecommerce/src/model/categogy.dart';
import 'package:ecommerce/src/helpers/colors_constant.dart';
import 'package:ecommerce/src/helpers/screen.dart';
import 'package:ecommerce/src/model/displaySize.dart';
import 'package:ecommerce/src/views/HomePage/Admin/Products/product_manager_controller.dart';
...
class _ProductAddingViewState extends State<ProductAddingView> {
  ...
  List<String> category = ['Laptop', 'Phone', 'Tablet'];
  List<String> sizeType = ['None', 'Laptop size', 'Phone size', 'Tablet size'];
  int indexSubCategory = 1;
  int indexSizeType = 0;
  String mainCategory = 'Laptop';
  ...
  String subCategory = 'Chọn hãng sản xuất';
  String sizeTypeValue = 'Chọn loại kích cỡ';
  ...
  List getSubCategory(int index) {
    ...
    switch (index) {
      case 0:
        break;
      case 1:
        subCategoryList = Category.Laptop;
        break;
      case 2:
        subCategoryList = Category.Phone;
        break;
      case 3:
        subCategoryList = Category.Tablet;
        break;
    }
  ...
  List<String> getSizeType(int index) {
    ...
    switch (index) {
      case 0:
        break;
      case 1:
        sizeTypeList = ClothingPickingList.LapSize;
        break;
      case 2:
        sizeTypeList = ClothingPickingList.PhoneSize;
        break;
      case 3:
        sizeTypeList = ClothingPickingList.TabSize;
        break;
    }
    return sizeTypeList;
  }
                ...
                Expanded(
                  ...
                  child: DropdownButton(
                    ...
                    onChanged: (value) {
                      setState(() {
                        mainCategory = value;
                        subCategory = 'Chọn hãng sản xuất';
                        switch (mainCategory) {
                          case 'Main Category':
                            indexSubCategory = 0;
                            break;
