...
import 'package:ecommerce/src/views/HomePage/Customer/CartPage/checkout_view.dart';
import 'package:ecommerce/src/widgets/button_raised.dart';
import 'package:ecommerce/src/widgets/card_cart_product.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        // TODO: Quantity Items
        title: Text(
          uiProductList.length.toString() + ' sản phẩm',
          style: TextStyle(
              color: kColorBlack,
