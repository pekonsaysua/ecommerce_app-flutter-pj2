...
import 'package:ecommerce/src/views/HomePage/Customer/HomePage/ProductDetail/detail_product_page.dart';
import 'package:ecommerce/src/views/HomePage/Customer/HomePage/ProductDetail/ProductPage/product_page.dart';
import 'package:ecommerce/src/views/HomePage/Customer/HomePage/ProductDetail/RatingPage/rating_product_page.dart';
        ...
        child: BottomNavigationBar(
          ...
          items: const [
            BottomNavigationBarItem(
                title: Text('Sản phẩm'), icon: Icon(Icons.rate_review)),
            BottomNavigationBarItem(
                title: Text('Chi tiết'), icon: Icon(Icons.rate_review)),
            BottomNavigationBarItem(
                title: Text('Đánh giá'), icon: Icon(Icons.rate_review)),
          ],
        ),
      ),
    );
